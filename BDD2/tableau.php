...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link" href="http://localhost/projet2/BDD2/tableau.php"><strong>Tableau de base</strong></a>
                    <a class="nav-link" href="http://localhost/projet2/BDD2/archive.php">Tableau des archives</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    if  (filtreRechercheActif() && !filtreBouttonActive()) {
        ...
        $liste_pc = $db_connexion->query('SELECT * from ordinateur WHERE delete_d = 1');
    }
    ?>
<br><br><br>
<form method="post">
    ...
    <table class="table table-dark table-striped">
        ...
        <tbody>
            ...
            foreach ($liste_pc as $pc) { // récupère toutes les données de la table ordinateur
                ...
                ?>
                    <form action="" method="POST">
                        <tr>
                            <td scope="row"><?= $pc["pc_id"] ?></td>
                            <td><span class="<?= ($pc["pc_ad"] == 1 & $pc["pc_sophos"] == 1 & $pc["pc_compta"] == 1 & $pc["pc_glpi"] == 1 ? "boutoncssgreen" : "boutoncssred") ?>"></span></td>
                            <!--Fonction ternaire -->
                            <td><INPUT type="text" NAME="pc_nom" value=<?= $pc["pc_nom"] ?>></td>
                            <td><INPUT NAME="pc_numserie" type="text" value=<?= $pc["pc_numserie"] ?>></td>
                            <td><INPUT NAME="pc_date" type="text" value=<?= $pc["pc_date"] ?>></td>
                            <td><INPUT name="ad_pc" class="checkboxcss" TYPE="checkbox" <?= ($pc["pc_ad"] == 1 ? "checked" : "") ?> /></p>
                            <td><INPUT NAME="sophos_pc" class="checkboxcss" TYPE="CHECKBOX" <?= ($pc["pc_sophos"] == 1 ? "checked" : "") ?>></p>
                            <td><INPUT NAME="compta_pc" class="checkboxcss" TYPE="CHECKBOX" <?= ($pc["pc_compta"] == 1 ? "checked" : "") ?>></p>
                            <td><INPUT NAME="glpi_pc" class="checkboxcss" TYPE="CHECKBOX" <?= ($pc["pc_glpi"] == 1 ? "checked" : "") ?>></p>
                            <td><INPUT NAME="decheterie_pc" class="checkboxcss" TYPE="CHECKBOX" <?= ($pc["pc_decheterie"] == 1 ? "checked" : "") ?>></p>
                            <td><INPUT NAME="cse_pc" class="checkboxcss" TYPE="CHECKBOX" <?= ($pc["pc_cse"] == 1 ? "checked" : "") ?>></p>
                            <td><textarea name="pc_com" rows="2" placeholder="Écrire un commentaire."><?= $pc["pc_com"] ?></textarea></td>
                            <td> <button type="submit" name='action' class="btn btn-outline-dark" value='modification'><strong>Modifier</strong></button></td>
                            <td><button type="submit" name='action' class="btn btn-outline-secondary" value='archiver'><strong>Archiver</strong></button></td>
            ...
            <form action="" method="POST">
                <tr>
                    <td></td>
                    <td><span NAME="pc_etat"></td>
                    <td><INPUT type="text" NAME="pc_nom"></td>
                    <td><INPUT NAME="pc_numserie" type="text"></td>
                    <td><INPUT NAME="pc_date" type="text"></td>
                    <td><INPUT name="ad_pc" class="checkboxcss" TYPE="checkbox" /></p>
                    <td><INPUT NAME="sophos_pc" class="checkboxcss" TYPE="CHECKBOX"></p>
                    <td><INPUT NAME="compta_pc" class="checkboxcss" TYPE="CHECKBOX"></p>
                    <td><INPUT NAME="glpi_pc" class="checkboxcss" TYPE="CHECKBOX"></p>
                    <td><INPUT NAME="decheterie_pc" class="checkboxcss" TYPE="CHECKBOX"></p>
                    <td><INPUT NAME="cse_pc" class="checkboxcss" TYPE="CHECKBOX"></p>
                    <td><textarea name="pc_com" rows="2" placeholder="Écrire un commentaire."></textarea></td>

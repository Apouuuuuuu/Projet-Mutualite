...
if (filtreRechercheActif()) {
    ...
    $requete1 = $db_connexion->prepare(
        ...
        imprimante.imprimante_nombre_nb_mois,
        imprimante.imprimante_nombre_coul_mois,
        ROUND(imprimante.imprimante_nb_prix * imprimante.imprimante_nombre_nb_mois, 2) AS imprimante_cout_nb_mois,
        ROUND(imprimante.imprimante_couleur_prix * imprimante.imprimante_nombre_coul_mois, 2) AS imprimante_cout_coul_mois,
        options_site.site_nom,
        options_site.site_id,
        ROUND((imprimante.imprimante_nb_prix * imprimante.imprimante_nombre_nb_mois) + (imprimante.imprimante_couleur_prix * imprimante.imprimante_nombre_coul_mois), 2) AS imprimante_cout_total
    FROM
        imprimante,
        options_site
    WHERE 
    imprimante.imprimante_site = options_site.site_id
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="http://localhost/projet2/BDD2/imprimante/imprimante_mensuel.php"><strong>Tableau mensuel</strong></a>
    ...
    if (isset($_POST["download"])) {
        ...
        $stmt = $pdo->query(
        'SELECT imprimante.imprimante_id,
        imprimante.imprimante_numserie,
        options_site.site_nom,
        imprimante.imprimante_ref,
        imprimante.imprimante_nombre_nb_mois,
    ...
    ORDER BY
        ...
        fputcsv($fp, ["ID", "Num Serie", "Site", "Reference", "Nb N&B", "Nb Coul", "Cout N&B", "Cout coul", "Total"]);
    ...
    <table class="table table-dark table-striped">
        <thead>
            <tr>
                ...
                <th scope="col">Nb N&B</th>
                <th scope="col">Nb Coul</th>
            ...
            ?>
                <form action="" method="POST">
                    <tr>
                        ...
                        <td><input type="text" name="imprimante_nombre_nb_mois" value="<?= $imprimante["imprimante_nombre_nb_mois"] ?>"></td>
                        <td><input name="imprimante_nombre_coul_mois" type="text" value="<?= $imprimante["imprimante_nombre_coul_mois"] ?>"></td>
